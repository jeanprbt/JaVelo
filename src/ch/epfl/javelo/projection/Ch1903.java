...
public final class Ch1903 {
    ...
    public static double e(double lon, double lat) {
        ...
        return 2_600_072.37 + 211_455.93 * lon1 - 10_938.51 * lon1 * lat1 - 0.36 * lon1 * Math.pow(lat1, 2) - 44.54 * Math.pow(lon1, 3);
    ...
    public static double n(double lon, double lat) {
        ...
        double lon1 = 1e-4 * (3600 * lonDegrees - 26_782.5);
        double lat1 = 1e-4 * (3600 * latDegrees - 169_028.66);
        return 1_200_147.07 + 308_807.95 * lat1 + 3745.25 * Math.pow(lon1, 2) + 76.63 * Math.pow(lat1, 2) - 194.56 * Math.pow(lon1, 2) * lat1 + 119.79 * Math.pow(lat1, 3);
    }
